---
name: verify-vision
description: ビジョンの良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**前提条件**:
- Phase 2-1が完了している
- `output/value-design.tsv` が存在し、ビジョンが記載されている

**出力ファイル**: `output/verify-vision-result.md`
...
`Task` ツールで `VerifyVision` エージェントを起動する。
...
- **ファイルパス**: `output/verify-vision-result.md`
