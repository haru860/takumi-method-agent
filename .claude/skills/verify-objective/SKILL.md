...
description: 目的の良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**前提条件**:
- Phase 3-2が完了している
- `output/value-analysis-objective.tsv` が存在し、目的が記載されている

**出力ファイル**: `output/verify-objective-result.md`
...
`Task` ツールで `VerifyObjective` エージェントを起動する。
...
- **ファイルパス**: `output/verify-objective-result.md`
