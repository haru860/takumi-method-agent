---
name: verify-planning-msp-plan
description: MSP計画の良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**前提条件**:
- `/planning-msp-plan` が完了している
- `output/msp-plan.md` が存在する

**出力ファイル**: `output/verify-planning-msp-plan-result.md`
...
`Task` ツールで `VerifyPlanningMspPlan` エージェントを起動する。
...
- **ファイルパス**: `output/verify-planning-msp-plan-result.md`
