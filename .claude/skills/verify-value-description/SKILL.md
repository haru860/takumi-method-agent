---
name: verify-value-description
description: 価値記述の良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**出力ファイル**: `output/verify-value-description-result.md`
...
`Task` ツールで `VerifyValueDescription` エージェントを起動する。
...
- **ファイルパス**: `output/verify-value-description-result.md`
