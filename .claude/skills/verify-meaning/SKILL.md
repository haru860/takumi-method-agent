---
name: verify-meaning
description: 意味の良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**前提条件**:
- Phase 2-4が完了している
- `output/value-design.tsv` が存在し、意味が記載されている

**出力ファイル**: `output/verify-meaning-result.md`
...
`Task` ツールで `VerifyMeaning` エージェントを起動する。
...
- **ファイルパス**: `output/verify-meaning-result.md`
