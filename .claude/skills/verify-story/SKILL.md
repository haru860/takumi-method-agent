---
name: verify-story
description: ストーリーの良い点・悪い点を分析し、改善点と改善のための問いを生成
---
...
**前提条件**:
- Phase 2-4が完了している
- `output/value-design.tsv` が存在し、ストーリーが記載されている

**出力ファイル**: `output/verify-story-result.md`
...
`Task` ツールで `VerifyStory` エージェントを起動する。
...
- **ファイルパス**: `output/verify-story-result.md`
